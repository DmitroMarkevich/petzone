                    ...
                    <div class="advert-item" data-status="<?php echo e($sale->status->value); ?>">
                        <div class="advert-left">
                            <div class="advert-image-wrapper">
                                <img src="<?php echo e($sale->main_image); ?>" class="advert-image" alt="<?php echo e($sale->advert->title); ?>">
                            </div>
                            ...
                            <div class="advert-content">
                                ...
                                <p>Служба
                                    доставки: <?php echo e(\App\Enum\DeliveryMethod::getTranslation($sale->delivery_method)); ?></p>
                        ...
                        <div class="advert-right">
                            <p class="advert-price"><?php echo e($sale->advert->price); ?>₴</p>
                        ...
                        <div class="advert-details" style="display: none;">
                            <div>
                                <p>Покупець</p>
                                <p>Ім'я <?php echo e($sale->buyer->first_name); ?></p>
                                <p>Прізвище <?php echo e($sale->buyer->last_name); ?></p>
                                <p>Номер Телефону <?php echo e($sale->buyer->phone_number); ?></p>
                            </div>

                            <div>
                                <p>Разом</p>
                                <p>Ціна <?php echo e($sale->total_price); ?></p>
                            </div>
                        </div>
                    </div>
